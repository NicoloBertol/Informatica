...
void Veicolo::accendi(){
    if(velocita!=0 && statoMotore==true){
        cout << "Il motore e' gia' acceso e il veicolo e' in movimento" << endl;
    }
    else{
        statoMotore=true;
        cout << "Il veicolo e' stato acceso" << endl;
    }
}
void Veicolo::spegni(){
    if(velocita==0 && statoMotore==false){
        cout << "Il motore e' gia' spento e il veicolo non e' in movimento" << endl;
    }
    else{
        frena();
        statoMotore=false;
        cout << "Il veicolo e' stato spento" << endl;
    }
}
...
bool Veicolo::getStatoMotore(){
    return statoMotore;
}
void Veicolo::mostraParametri(){
    cout << "Marca: " << marca << endl;
    cout << "Modello: " << modello << endl;
    cout << "Velocita: " << velocita << endl;
    cout << "statoMotore: " << statoMotore << endl;
}